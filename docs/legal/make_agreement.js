...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      h2('Background'),
      body('A. The Licensor has composed melodies for, and performed and recorded, chanted renditions of Sanskrit works (verses, passages, and other Sanskrit texts she has performed for the Licensee), listed non-exhaustively in Annex A (the “Recordings”). Per MG ruling 08-08-2026, the license covers all Sanskrit works she has done for the project — not only Bhagavadgītā examples.'),
      ...
      body('C. The Licensor wishes to permit the Licensee to use the Recordings in that project on the terms below. Fact date recorded: 08-08-2026.'),

      h2('1. Grant of license'),
      clause('1.1', 'The Licensor grants the Licensee a non-exclusive, worldwide, royalty-free license, for the full term of copyright and related rights in the Recordings (including all Sanskrit works she has performed or will add under clause 5.1 for this project), to: (a) reproduce, store and technically convert the Recordings; (b) synchronise the Recordings with visual material (including syllable-level karaoke animation, captions, transliteration and translations) to create derivative audiovisual works (“Karaoke Videos”); (c) communicate the Recordings and Karaoke Videos to the public on any platform, including the Sanskrit Karaoke web application, Telegram, YouTube, Instagram, TikTok, VK and successor or comparable platforms; and (d) use short excerpts of the Recordings and Karaoke Videos to advertise the Licensee’s Sanskrit courses and the Sanskrit Karaoke project.'),
      ...
      body('Each Recording ID below is referenced as audio.permission_ref in the Sanskrit Karaoke verse catalogue. Annex A is an inventory only — the grant (clause 1.1) covers all Sanskrit works the Licensor has done for the project, not only the rows listed here.'),
      new Table({
        width: { size: 9026, type: WidthType.DXA },
        columnWidths: CW,
        rows: [
          annexHeader,
          annexRow('USK-2026-001', 'Bhagavadgītā 2.47 (karmaṇy evādhikāras te…)', 'Bhagavadgītā', '08-08-2026', '[s]'),
          annexRow('USK-2026-002', 'Bhagavadgītā 2.48 (yogasthaḥ kuru karmāṇi…)', 'Bhagavadgītā', '08-08-2026', '[s]'),
          annexRow('USK-2026-003', 'Bhagavadgītā 2.49 (dūreṇa hy avaraṃ karma…)', 'Bhagavadgītā', '08-08-2026', '[s]'),
          annexRow('USK-…', '(further Sanskrit works as recorded)', 'any Sanskrit text', '08-08-2026+', '[s]'),
          annexRow('', '', '', '', ''),
        ],
      }),
      para(t('Annex A signed/confirmed by both Parties as part of Agreement SK-LIC-2026-001. Scope ruling 08-08-2026: all Sanskrit works done — not BG-only.', { size: 20, italics: true }),
        { spacing: { before: 240 } }),
    ],
  }],
});

...
out = {
    '_about': ('H5227 gold set: per-syllable consonant-attack times (seconds, absolute clip time), '
               ...
               '(subh_1375 pada 2-4, subh_0605 half 2, subh_1221 pada 2) is labelled by syllable POSITION. '
               'H5227 read 5 verses; H5235 added subh_0513, subh_0605, subh_5909, subh_1221, subh_4693, '
               'read before any assigner output on them was visible.'),
    '_audio': AUDIO_SRC,
    'verses': {},
}

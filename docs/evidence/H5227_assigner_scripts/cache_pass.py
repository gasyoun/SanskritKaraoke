...
import sys, os, json
WT = '/Users/mac/Documents/GitHub/SanskritKaraoke-h5227-74101'
sys.path.insert(0, os.path.join(WT, 'tools'))
import numpy as np
import align_chapter as ac

AUDIO = '/tmp/opencode/h5223check/audio_batch'
OUT = '/private/tmp/claude-502/-Users-mac-Documents-GitHub/b8662535-9cc1-48ec-b73e-e611747156f8/scratchpad/cache'

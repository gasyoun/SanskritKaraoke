"""H5227 design 2 rev b (pada-final lengthening, graded pauses): design 1 + pada/pause structure, weaker prediction pull."""
import math
import numpy as np
...
DEFAULT = dict(wp=0.1, cap=0.6, a_skip=0.3, d0=5.0, b_un=1.2, wt=1.0,
               ...
               cross_pen=0.75, full_pause=0.4, pf=1.4)

GRID = dict(wp=[0.03, 0.1, 0.2], wt=[0.5, 1.0, 1.5], a_skip=[0.2, 0.3, 0.45],
            pada_bonus=[0.5, 1.0, 2.0], cross_pen=[0.3, 0.75, 1.5], pf=[1.2, 1.5, 2.0])

...
def create_mock_logs():
    ...
    mocks = [
        ...
        {"timestamp": "2026-05-15T00:01:00", "provider": "anthropic", "model": "claude-sonnet-5", "prompt_tokens": 1500, "completion_tokens": 500, "total_tokens": 2000, "estimated_cost_usd": 0.008, "metadata": {"verse_id": "bhg_2_47"}},

...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 5b2296ad1f]
...
- Task routing: [CLAUDE.md](https://github.com/gasyoun/SanskritKaraoke/blob/main/CLAUDE.md) — open the matching section; do not read the file end-to-end. Sections: Project · Running locally · Common Commands · Environment Setup · Versioning workflow · File structure · Architecture · Core data structures · Reading / writing app.js · Google Drive config (in app.js) · Mobile support status · Mobile QA checklist · Known incomplete features · Agent Engineering Roadmap · Use Case Scenarios · Operational hazard notes.

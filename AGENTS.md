...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 4ea5895de3]
...
- Task routing: [CLAUDE.md](https://github.com/gasyoun/SanskritKaraoke/blob/main/CLAUDE.md) — open the matching section; do not read the file end-to-end. Sections: How to run · Version string — five places · Key files · Do not touch.
